    ...
    <section id="home" style={{ padding: "4rem 0" }}>
      ...
      >
        <AnimatedSection direction="left" delay={0.1}>
          <div>
            <p style={{ letterSpacing: 2, color: "#ffb300", fontWeight: 700 }}>
              HELLO
            </p>
            ...
            <p style={{ maxWidth: 720 }}>
              I build secure, reliable, and scalable web applications with a
              focus on performance and user experience. Currently working at
              Velox Solutions, where I contribute to developing Endpoint
              Detection & Response (EDR) and HRM systems, ensuring security,
              efficiency, and innovation in enterprise applications.
            </p>
            <div
              style={{
                display: "flex",
